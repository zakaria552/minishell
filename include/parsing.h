...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/05 11:16:25 by zfarah            #+#    #+#             */
/*   Updated: 2025/09/05 12:00:28 by zfarah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					*concat_string_types(t_arena *arena, t_vector *vec,
							int *i, bool *x);
char					*strip_quotes(t_arena *arena, char *str,
							bool should_strip);
...
// parsing.c
t_vector				*tokenize_and_parse(char *s, t_arena *arena,
							char delimiter);
t_vector				*parse_tokens_to_commands(t_arena *arena,
							t_vector *vec);
...
void					update_command(t_arena *arena, t_cmd *command,
							t_vector *vec, int *i);
// debug
