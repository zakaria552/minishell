...
SRC_UTILS	:= error_handlers.c prompt.c expand_str.c clean_up.c
SRC_VECTOR	:= vector.c utils.c
SRC_SIGNAL	:= signal.c here_doc_signals.c child_process_signals.c
SRC_PARSING	:= tokenize.c token_lengths.c parsing.c arena_strings.c command.c\
				syntax.c expansion.c concatenate_strings.c token_utils.c split_string.c
SRC_EXEC	:= io_redirets.c execute.c execute_builtins.c binary_path.c here_doc_handler.c here_doc_utils.c execute_utils.c
...
$(LIBFT):
	...
	--branch v1.0.0 \
	--single-branch \
	https://github.com/zakaria552/libft.git $(LIBFT_DIR) > /dev/null 2>&1
