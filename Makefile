...
## Sources
OBJ_DIR 	:= obj
VPATH 		:= src:src/arena_allocator:src/utils:src/vector:src/parsing:src/execution:src/builtins
...
SRC_BUILTINS:= local_vars.c local_var_utils.c b_utils.c env.c unset.c exit.c export.c
SRC 		:= \
			main.c \
			$(SRC_ARENA) \
			$(SRC_UTILS) \
