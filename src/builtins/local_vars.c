...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/05 10:28:34 by zfarah            #+#    #+#             */
/*   Updated: 2025/09/05 10:28:35 by zfarah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static void		bubble_sort_vars(t_vector *sorted, t_env_var *var,
					t_env_var *var_n, t_env_var *tmp);

t_local_vars	*get_local_vars(void)
{
...
t_vector	*sorted_envp_vars(t_local_vars *vars)
{
	...
	var_n = NULL;
	i = -1;
	sorted = init_vector(vars->envp->size, NULL, get_allocators()->prompt);
...
static void	bubble_sort_vars(t_vector *sorted, t_env_var *var, t_env_var *var_n,
		t_env_var *tmp)
{
	int	i;
	int	j;
